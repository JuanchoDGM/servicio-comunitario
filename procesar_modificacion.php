...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_representante = "UPDATE representantes SET nombres='$representante_nombres', apellidos='$representante_apellidos', cedula='$representante_cedula', telefono='$representante_telefono', fecha_nacimiento='$representante_fecha_nacimiento', nacionalidad='$representante_nacionalidad', estado_civil='$representante_estado_civil', grado_instruccion='$representante_grado_instruccion', numero_hijos='$representante_numero_hijos', hijos_estudian='$representante_hijos_estudian', religion='$representante_religion', vive_con_nino='$representante_vive_nino'";
